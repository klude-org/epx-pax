...
class query {
    ...
    protected function __construct(\epx__250631_01_db__pax__klude_org__github $db){ 
        $this->DB = $db;
    }
    ...
    public function sql(string $types = \epx__250631_01_db__pax__klude_org__github\query::FULL){
