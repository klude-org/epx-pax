<?php 
    ...
    $o->sidebar = (function(){ 
        ...
        } else if($file = $this->context->file('console/sidebar-$.json')){
...
<body>
    ...
    <script>
        ...
        const CTLR_URL = '<?=o()->env->ctlr_url?>'
        const BASE_URL = '<?=o()->env->base_url?>'
        const SITE_URL = '<?=o()->env->site_url?>';
        const ROOT_URL = '<?=o()->env->root_url?>';
